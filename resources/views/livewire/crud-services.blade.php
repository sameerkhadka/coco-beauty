<div class="main">
    ...
    <div class="main-aside {{ $menuOpen ? 'open' : '' }}">
        <div class="add-mem">
            <h4>{{ isset($modelData['id']) ? 'Update' : 'Add' }} Services</h4>
...
{{--                </div>--}}
                ...
                <div class="addm-sing">
                    <label>Image</label>
                    @if($serviceHardImage)
                        <img style="width: 100px; height: 100px;border: solid 1px; border-radius: 10px; margin-bottom: 3px;" src="{{$serviceHardImage->temporaryUrl()}}" alt="">
                    @endif
                    <input type="file" wire:model.debounce.500ms="serviceHardImage" autocomplete="off">
                </div>

                <div class="addm-sing">
                    <label>Order</label>
                    <input type="number" wire:model.debounce.500ms="modelData.order" autocomplete="off">
                </div>
