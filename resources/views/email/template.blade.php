...
<section class="wrapper" >
        <div class="container">
            ...
            <div class="content-body" style="margin-top: 60px;">
                <h4 style="font-family:helvetica,sans-serif;text-decoration:none;color:#333;margin:0;padding:0;font-weight: 100;">Dear <span style="font-weight: 600;" > Yogesh Karki</span></h4>
                ...
                <p style="font-family:helvetica,sans-serif;text-decoration:none;color:#333;font-weight:300;display:block;font-size:16px;line-height:24px;margin:1em 0;padding:0">Let's make your birthday the most memorable one at <span>Coco Beauty Lounge</span> with our Luxurious Beauty Treatment </p>
